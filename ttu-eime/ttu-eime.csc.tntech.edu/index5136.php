...
; http://ttu-eime.csc.tntech.edu/index.php?title=File:Tricycle.zip&action=edit&externaledit=true&mode=file&internaledit=1
...
[File]
Extension=zip
URL=http://ttu-eime.csc.tntech.edu/images/b/be/Tricycle.zip
